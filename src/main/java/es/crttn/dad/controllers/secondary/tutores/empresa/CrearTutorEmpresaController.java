...
public class CrearTutorEmpresaController implements Initializable {
    ...
    private final IntegerProperty telefonoProperty = new SimpleIntegerProperty();


    public CrearTutorEmpresaController() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/primary/tutores/empresa/CrearTutorEmprView.fxml"));
    ...
    void onAddAction(ActionEvent event) {
        ...
        String querry = "INSERT INTO tutorempresa (nombre, apellido, correo, telefono) VALUES (?, ?, ?, ?)";
        ...
        try (Connection connection = DatabaseManager.getDataSource().getConnection();
            ...
            System.out.println("TutorEmpresa creado: " + filasAfectadas + " fila(s) afectada(s)");
